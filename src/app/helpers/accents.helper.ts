...
export class AccentsHelper {
    ...
    public static removeDiacritics(str: string): string {
        for (let i = 0; i < AccentsHelper.defaultDiacriticsRemovalMap.length; i++) {
            str = str.replace(AccentsHelper.defaultDiacriticsRemovalMap[i].letters, AccentsHelper.defaultDiacriticsRemovalMap[i].base);
        }
        return str;
    }
}
